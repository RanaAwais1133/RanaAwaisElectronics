...
func SetupRouter(
	...
	protected.HandleFunc("/inventory/stats", inventoryH.GetInventoryStats).Methods("GET")
	protected.HandleFunc("/inventory/variants/{productName}", inventoryH.GetProductVariants).Methods("GET")
