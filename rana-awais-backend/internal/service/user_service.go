...
// ChangePassword changes the user password (requires old password verification)
...
// UpdatePassword updates the user password (admin override, no old password check)
