...
type InstallmentPlan struct {
	...
	// InstallmentDate: day of month (1-31) when installment is due.
	// If 0, defaults to same day as start date.
	InstallmentDate int `bson:"installment_date,omitempty" json:"installmentDate,omitempty"`

	// ✅ NEW: Payment Type - "cash" or "installments"
	PaymentType string `bson:"payment_type,omitempty" json:"paymentType,omitempty"` // "cash" or "installments"
