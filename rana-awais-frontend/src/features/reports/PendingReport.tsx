  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <div class="footer">
          ${isUrdu ? 'رانا عويس الیکٹرانکس' : 'Rana Awais Electronics'} — ${isUrdu ? 'پرنٹ کی تاریخ' : 'Print Date'}: ${new Date().toLocaleDateString()} | ${isUrdu ? 'تیار کردہ' : 'Generated By'}: ${currentUser?.displayName || currentUser?.username || '—'}
        </div>
