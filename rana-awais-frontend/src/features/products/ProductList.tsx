...
const ProductCard: React.FC<{
  ...
  t: (key: string) => string;
}> = ({ product, isUrdu, onEdit, onAddStock, onDelete, t }) => {
  const isInStock = (product.stockCount || 0) > 0;

  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-5 relative group hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
      {/* ✅ Action Buttons */}
      ...
      {/* ✅ Product Info */}
      <h3 className="font-bold text-base sm:text-lg mb-1 text-gray-800 dark:text-white pr-16">
